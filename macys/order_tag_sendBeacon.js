    ...
    (function (id, loader) {
        ...
        u.send = function (a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
              ...
              // BEGIN NEW TAG SENDING CODE
                var fullUrl = u.data.base_url + u.data.qs_delim + qs.join(u.data.qsp_delim);
                ...
                if (navigator.sendBeacon) {
                    ...
                    navigator.sendBeacon(u.data.base_url, formData);
                } else {
                    (new Image()).src = fullUrl;
                }

              // END NEW TAG SENDING CODE
