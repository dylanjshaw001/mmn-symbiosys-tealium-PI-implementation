//tealium universal tag - utag.2045 ut4.0.202506021926, Copyright 2025 Tealium.com Inc. All Rights Reserved.
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                u.data = {
                    ...
                    "qs_delim": "" || "?",
                    "tag_type": "img",
                    "base_url": "https://event.symbiosys.dev/page_viewjs",
                    "secure_base_url": "",
                ...
                for (var key in u.data) {
                    if (!u.data.hasOwnProperty(key))
                        continue;
                    var val = u.data[key];
                    if (['base_url', 'qs_delim', 'qsp_delim', 'kvp_delim', 'tag_type', 'static_params'].indexOf(key) > -1)
                        continue;
                    if (val != null && val !== '') {
